...
public class ZQQSplashActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		AdManager.getInstance(this).init("7e123f04418853f6","2e98cae681b867a2", false); 
		...
		//		mDefaultCid : 渠道号，默认的是，可以不要这个参数，原来的Dianle.initDianleContext(this, "072cb4d9d9d5dfd23ed2981e5e33fe59")方法也有效。。
		Dianle.initDianleContext(this, "55dcf316c8106d8c5b0563d6acf28ddc");
		Dianle.setCustomActivity("com.sanqi.zqq.dlnetwork.MyView");
		Dianle.setCustomService("com.sanqi.zqq.dlnetwork.MyService");
		...
		if(A.isSim){
//			Toast.makeText(getApplicationContext(), "没有插入电话卡，请先插入电话卡。", Toast.LENGTH_LONG).show();
		}
...
//					}
	...
	private void getPhoneInfo() {
		...
		// Log.i("tm.getLine1Number()", tm.getLine1Number());
		/*
